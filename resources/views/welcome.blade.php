...
<div id="contact_us" class="my-2" style="min-height: 100vh; background-color: rgba(255, 255, 255, 0.2)">
  <h1 class="text-center p-3" style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;font-weight:500">HUBUNGI KAMI</h1>
  <div class="container">
    <div class="row">
