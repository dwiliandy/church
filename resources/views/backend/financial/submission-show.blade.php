...
@section('content')
	<div class="container mx-auto">
		<nav class="breadcrumb flex-col">
			<ol class="flex">
				...
				<li class="breadcrumb-item" aria-current="page"><a class="text-blue-500"href="{{ route('submissions') }}">Pengajuan</a>
				</li>
			...
			<div class="col-12">
				<div class="card shadow-sm border-0">
					<div class="card-body p-0">
						{{ $dataTable->table(['class' => 'table table-hover table-bordered w-100 mb-0']) }}
					</div>
				</div>
			</div>
		</div>
	...
	@if ($can_action == true)
		<div id="floating-button" class="floating d-flex justify-content-center align-items-center">
			<button type="submit" data-toggle="modal" data-target="#approve" class="button-floating-approve m-2"
				data-toggle="tooltip" data-placement="top" title="Setujui"><i class="fas fa-check"></i></button>
			<button type="submit" data-toggle="modal" data-target="#disapprove" class="button-floating-disapprove m-2"
				data-toggle="tooltip" data-placement="top" title="Tolak" onclick="(resetDelete())"><i
					class="fas fa-times"></i></button>
		</div>
	@endif

	{{-- Approve Modal --}}
	<div class="modal fade" id="approve" data-backdrop="static" data-keyboard="false" tabindex="-1"
				...
				<div class="modal-content text-green-600">
					<div class="modal-body">
						<div class="p-5">
							...
							<h2 class="text-center text-gray-700 text-xs font-bold">(Anda tidak dapat mengubah aksi setelah menekan tombol
								OK)</h2>
					...
					<div class="modal-footer d-block">
						<div class="row d-flex justify-content-center">
							<div class="col-4">
								<button type="button" class="btn bg-red-500 hover:bg-red-700 text-white w-full"
	...
	{{-- Disapprove Modal --}}
	<div class="modal fade" id="disapprove" data-backdrop="static" data-keyboard="false" tabindex="-1"
		aria-labelledby="createModalLabel" aria-hidden="true">
		<div class="modal-dialog">
				...
				<div class="modal-body">
					<form id="delete">
						<div class="p-5">
							...
							<input type="hidden" name="finance_disapprove" id="finance_disapprove"
								value={{ base64_encode($financial->id) }}>
						</div>
						<div class="row d-flex justify-content-center">
							<div class="col-4">
								<button type="button" class="btn bg-red-500 hover:bg-red-700 text-white w-full"
