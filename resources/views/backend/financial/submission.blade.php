				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="create">
							<div class="row">
								<div class="col-12">
									<label for="date" class="form-label">Tanggal Transaksi (Pilih tanggal dari icon kalender)<span
											class="required"> *</span></label>
									<input type="date" name="date" class="form-control" id="date" onchange="checkDate()"
				...
				$("#create").on("submit", function(e) {
					...
					$.ajax({
						...
						success: (response) => {
							...
							$('#financial-submissions-table').DataTable().ajax.reload();
