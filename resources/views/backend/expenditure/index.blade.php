	...
	<div class="container mx-auto">
		<nav class="breadcrumb flex-col">
			<ol class="flex">
				...
				<li class="breadcrumb-item active text-blue-500" aria-current="page"><span class="">Master Data Pengeluaran<span>
				</li>
			</ol>
		...
		<div class="modal fade" id="editModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h1 class="modal-title text-success" id="editModalLabel">Ubah Data Pengeluaran</h1>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					<div class="modal-body">
						<form id="edit">
							...
							<div class="row">
								<div class="col-12">
									<label for="edit_unique_id" class="form-label">Kode Unik (Max:10 Karakter)<span class="required">
											*</span></label>
	...
	@push('js')
		...
		<script>
			...
			$("#create").on("submit", function(e) {
				...
				$.ajax({
					...
					success: (response) => {
						...
						$('#expenditures-table').DataTable().ajax.reload();
			...
			function editData(id) {
				$('.preloader').show();
				$.ajax({
					url: "/admin/expenditures/" + btoa(id) + "/edit",
					method: "GET",
			...
			function deleteData(id) {
				...
				$('.btn-destroy').attr("data-id", btoa(id));
			}
