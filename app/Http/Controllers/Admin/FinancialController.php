...
use App\DataTables\FinancialsDataTable;
use App\DataTables\FinancialSubmissionsDataTable;
use App\DataTables\ApprovalDetailsDataTable;
...
{
  public function index($year, FinancialsDataTable $dataTable)
  {
    $year_name = Year::where('id', base64_decode($year))->first()->name;
    return $dataTable->render('backend.financial.index', compact('year', 'year_name'));
  }
  ...
  public function submissions(FinancialSubmissionsDataTable $dataTable)
  {
    return $dataTable->render('backend.financial.submission');
  }

  public function submissionDetail($finance, ApprovalDetailsDataTable $dataTable)
  {
    ...
    return $dataTable->render('backend.financial.submission-show', \compact('financial', 'can_action'));
  }
