...
class FamiliesDataTable extends DataTable
{
  ...
  public function query(Family $model): QueryBuilder
  {
    return $model->newQuery()
      ->select('families.*', 'groups_data.name as group_name')
      ->leftJoin('groups_data', 'families.group_id', '=', 'groups_data.id');
  }
  ...
  public function getColumns(): array
  {
    return [
      ...
      Column::make('name')->title('Nama Keluarga'),
      Column::make('group_name')->title('Kolom')->data('group_name')->name('groups_data.name'),
